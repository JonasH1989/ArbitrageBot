...
# ============================================================================
    ...
    # =========================================================================
    # SECTIONS - All collapsed by default except Übersicht
    # =========================================================================
    ...
    with st.expander("📋 Orderbook", expanded=False):
        st.info("Orderbook-Daten werden hier angezeigt.")
    
    # Einstellungen
    with st.expander("⚙️ Einstellungen", expanded=False):
        st.info("Pair-Einstellungen werden hier angezeigt.")
    
    # Fee Empfehlung
    with st.expander("⚠️ Fee Empfehlung", expanded=False):
        st.info("Fee-Empfehlungen werden hier angezeigt.")
    
    # Wallet
    with st.expander("💰 Wallet", expanded=False):
        st.info("Wallet-Daten werden hier angezeigt.")
